...
IL_0016:
	{
		...
		bool L_6;
		L_6 = NativeArray_1_get_IsCreated_m33B9B8E7A737223615F73D6F7558A95BEEE5E0D9_inline(L_5, il2cpp_rgctx_method(method->rgctx_data, 2));
		if (!L_6)
		{
			goto IL_0024;
		}
...
IL_0024:
	{
		...
		*(NativeArray_1_t5DD3ABF166BF1625D52FA4E593A2E0C17AD5E01E*)L_8 = L_10;
		int32_t L_11;
		L_11 = UnsafeUtility_SizeOf_TisMagicLeapTouchpadGestureEvent_t67201AB9AC7B1CC1F51A273C6FB428FC0C390506_m1DCDDB289072A27DE8F19282BAFE7839E1D723B5_inline(il2cpp_rgctx_method(method->rgctx_data, 6));
